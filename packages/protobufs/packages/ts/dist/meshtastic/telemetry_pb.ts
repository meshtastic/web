 ...
 */
export type TrafficManagementStats =
  Message<"meshtastic.TrafficManagementStats"> & {
    /**
     *
 ...
 */
export const TelemetrySchema: GenMessage<Telemetry> /*@__PURE__*/ = messageDesc(
